...
function App() {
  ...
  useEffect(() => {
    async function getData() {
      const response = await axios.get(
        "https://63429d8e3f83935a7845ee39.mockapi.io/student"
      );
  ...
  const handleDelete = async (id) => {
    const response = await axios.delete(
      `https://63429d8e3f83935a7845ee39.mockapi.io/student/${id}`
    );
    ...
    if (errKeys.length >= 1) {
      ...
      if (formData.id) {
        ...
        const response = await axios.put(
          `https://63429d8e3f83935a7845ee39.mockapi.io/student/${formData.id}`,
          {
            name: formData.name,
            age: formData.age,
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <br /> <br />
        <FormControl fullWidth>
          <InputLabel id="Courses">Mentor</InputLabel>
          <Select
            labelId="demo-simple-select-label"
            id="demo-simple-select"
            label="Mentor"
          ...
          >
            ...
            <MenuItem value="rufus">Rufus</MenuItem>
            <MenuItem value="sabari">Sabari</MenuItem>
          </Select>
        </FormControl>
        <br />
        <span style={{ color: "red" }}>{formData.error.mentor}</span>
        <br /> <br />
